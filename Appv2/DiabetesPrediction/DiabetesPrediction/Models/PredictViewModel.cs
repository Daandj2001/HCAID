...
namespace DiabetesPrediction.Models
{
    public class PredictViewModel
    {
        ...
        [DisplayName("Now thinking about your physical health, which includes physical illness and injury, for how many days during the past 30 days was your physical")]
        ...
        [DisplayName("physical activity in past 30 days - not including job")]
